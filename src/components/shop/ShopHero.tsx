        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-8 text-white/90 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-display font-bold text-white mb-1">2,500+</div>
              <div className="text-sm md:text-base font-body text-white/70">Clients satisfaits</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-display font-bold text-white mb-1">5,000+</div>
              <div className="text-sm md:text-base font-body text-white/70">Commandes livrées</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-display font-bold text-white mb-1">4.9/5</div>
              <div className="text-sm md:text-base font-body text-white/70">Note moyenne</div>
            </div>
          </div>
        </div>
      </div>
