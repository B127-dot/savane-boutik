...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-background text-foreground selection:bg-primary/30 selection:text-primary">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <motion.div 
          className="absolute bottom-[10%] right-[5%] text-primary/5"
          animate={{ 
            y: [0, -15, 0],
            rotate: [12, 17, 12]
          }}
        ...
        <motion.div 
          className="absolute top-[15%] right-[15%] text-primary/5"
          animate={{ 
            y: [0, -20, 0],
            rotate: [45, 50, 45]
          }}
        ...
        <motion.div 
          className="absolute bottom-[20%] left-[10%] text-primary/5"
          animate={{ 
            y: [0, -15, 0],
            rotate: [-12, -7, -12]
          }}
      ...
      <main className="relative z-10 w-full max-w-[1200px] mx-auto p-4 lg:p-6">
        <motion.div 
          className="w-full min-h-[640px] lg:h-[750px] rounded-[32px] overflow-hidden grid grid-cols-1 lg:grid-cols-12 
            bg-card/70 backdrop-blur-xl border border-border/30 
            shadow-[0_0_0_1px_rgba(0,0,0,0.2),0_20px_60px_-10px_rgba(0,0,0,0.6)]"
          ...
          <div className="lg:col-span-5 flex flex-col justify-between p-8 sm:p-12 lg:p-14 relative bg-secondary/20">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Input
                    ...
                    required
                    className="h-12 px-4 rounded-xl bg-secondary/40 border-border/30 text-foreground placeholder:text-muted-foreground/50
              ...
              <Button 
                type="submit" 
                disabled={isLoading}
                className="group w-full h-12 rounded-xl text-sm font-semibold bg-primary hover:bg-primary/90 text-primary-foreground
            ...
            >
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-[10px] uppercase tracking-wider">
                  <span className="bg-card px-3 text-muted-foreground/50">Nouveau vendeur ?</span>
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  <div className="flex -space-x-2">
                    <img 
                      className="inline-block h-8 w-8 rounded-full ring-2 ring-background grayscale hover:grayscale-0 transition-all object-cover" 
                      src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=64&h=64" 
                      alt="Vendeur"
                    />
                    <img 
                      className="inline-block h-8 w-8 rounded-full ring-2 ring-background grayscale hover:grayscale-0 transition-all object-cover" 
