...
const Signup = () => {
  ...
  const benefits = [
    { icon: Zap, text: "Boutique en ligne en 5 minutes" },
    { icon: Gift, text: "Gratuit pour démarrer" },
    { icon: CheckCircle2, text: "Paiements mobiles intégrés" },
  ];
    ...
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-background text-foreground selection:bg-primary/30 selection:text-primary">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <motion.div 
          ...
          animate={{ y: [0, -20, 0], rotate: [-12, -7, -12] }}
        ...
        <motion.div 
          className="absolute bottom-[15%] right-[8%] text-primary/5"
        ...
        <motion.div 
          className="absolute top-[20%] right-[12%] text-primary/5"
        ...
        <motion.div 
          className="absolute bottom-[25%] left-[5%] text-primary/5"
      ...
      <main className="relative z-10 w-full max-w-[1200px] mx-auto p-4 lg:p-6">
        <motion.div 
          className="w-full min-h-[700px] lg:min-h-[800px] rounded-[32px] overflow-hidden grid grid-cols-1 lg:grid-cols-12 
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    <Input
                      ...
                      required
                      className="h-11 px-4 rounded-xl bg-secondary/40 border-border/30 text-foreground placeholder:text-muted-foreground/50
            ...
            >
              <div className="relative mb-4">
                ...
                <div className="relative flex justify-center text-[10px] uppercase tracking-wider">
                  <span className="bg-card px-3 text-muted-foreground/50">Déjà inscrit ?</span>
                </div>
              </div>
