...
const blogArticles = [
  ...
  {
    id: 6,
    title: "Instagram Shopping : Le guide complet pour les vendeurs africains",
    excerpt: "Transformez votre compte Instagram en véritable boutique en ligne. Toutes les étapes pour activer Instagram Shopping.",
